...
class edx(object):
    ...
    def setGrade(self, grade, course="6.01x"):
        ...
        for c in self.myCourses:
             if course == c.courseName:
                c.setGrade(grade)
                #print course, c.courseName, grade, c.getGrade()
    ...
    def getGrade(self, course="6.02x"):
        ...
        for c in self.myCourses:
            if course == c.courseName:
               get = c.getGrade()
               #print course, c.courseName, c.getGrade(), get
